...
public class OtherSoundSettings extends SettingsPreferenceFragment implements Indexable {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (!SettingsUtils.isMorphExodus(mContext.getContentResolver())) {
            removePreference("volume_steps");
            removePreference(KEY_VOLUME_STEPS_ALARM);
            removePreference(KEY_VOLUME_STEPS_DTMF);
            removePreference(KEY_VOLUME_STEPS_MUSIC);
            removePreference(KEY_VOLUME_STEPS_NOTIFICATION);
            removePreference(KEY_VOLUME_STEPS_RING);
            removePreference(KEY_VOLUME_STEPS_SYSTEM);
            removePreference(KEY_VOLUME_STEPS_VOICE_CALL);
        }
