...
public class PowerUsageSummary extends SettingsPreferenceFragment
    ...
    public void onCreate(Bundle icicle) {
        ...
        currentMorph = SettingsUtils.CurrentMorphMode(getActivity().getContentResolver());
    ...
    @Override
    public void onPause() {KEY_BATTERY_SAVER
