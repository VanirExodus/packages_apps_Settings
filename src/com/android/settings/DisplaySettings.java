...
import com.android.exodussettings.ExodusUtils;
...
public class DisplaySettings extends SettingsPreferenceFragment implements
    ...
    private static int getXmlResource(Context context) {
        if (ExodusUtils.isMorphCyanogenMod(context)) {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        onCreateSpecifics(activity);
    }
    
    private void onCreateSpecifics(Context context) {
        if (ExodusUtils.isMorphCyanogenMod(context)) {
            onCreateCmSpecific();
        } else if (ExodusUtils.IsMorphAosp(context)) {
