...
public class BatterySaverSettings extends SettingsPreferenceFragment
    ...
    private void initWarningColor() {
        ...
        } else if (Integer.parseInt(mWarningColorStyle.getValue()) == 2) {
            int intColor = Settings.System.getInt(resolver,
                    Settings.System.BATTERY_SAVER_MODE_CUSTOM_COLOR, -2);
            mCustomWarningColor.setSummary(getResources().getString(R.string.empty_string));
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        if (preference == mWarningColorStyle) {
            ...
            if (warningStyle == 0) {
                ...
                String hex = ColorPickerPreference.convertToARGB(mCustomWarningColor.getValue());
                int intHex = ColorPickerPreference.convertToColorInt(hex);
                Settings.System.putInt(getActivity().getContentResolver(),
                        Settings.System.BATTERY_SAVER_MODE_CUSTOM_COLOR, intHex);
                String hexColor = String.format("#%08x", (0xffffffff & intHex));
                mCustomWarningColor.setSummary(hexColor);
                mCustomWarningColor.setEnabled(true);
            } else {
                Settings.System.putInt(getActivity().getContentResolver(),
                        Settings.System.BATTERY_SAVER_MODE_CUSTOM_COLOR, -3);
                mCustomWarningColor.setSummary(getResources().getString(R.string.empty_string));
                mCustomWarningColor.setEnabled(false);
            }

            preference.setSummary(mWarningColorStyle.getEntry());
