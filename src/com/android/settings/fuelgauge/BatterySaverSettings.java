...
public class BatterySaverSettings extends SettingsPreferenceFragment
    ...
    private String mCustomWarningColor = "0xf4511e";
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        mWarningColorStyle = (ListPreference) findPreference(PREF_COLOR_PICKER);
    ...
    private void initColorPicker() {
        ...
        mCustomWarningColor = Settings.System.getString(resolver, Settings.System.STATUS_BAR_GREETING);
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        if (preference == mWarningColorStyle) {
            ...
            if (warningStyle == 0) {
                ...
                hex = ColorPickerPreference.convertToARGB(Integer.valueOf(String
                        .valueOf(newValue)));
