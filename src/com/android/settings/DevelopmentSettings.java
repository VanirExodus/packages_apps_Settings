...
public class DevelopmentSettings extends SettingsPreferenceFragment
    ...
    public void onCreate(Bundle icicle) {
        ...
        mResetSbPrefs.add(mImmediatelyDestroyActivities);
        ...
        mResetSbPrefs.add(mShowAllANRs);
    ...
    void updateSwitch(SwitchPreference switchBox, boolean value) {
    ...
    private void resetDangerousOptions() {
        ...
        for (int i=0; i<mResetSbPrefs.size(); i++) {
            SwitchPreference sb = mResetSbPrefs.get(i);
            if (sb.isChecked()) {
                sb.setChecked(false);
                onPreferenceTreeClick(null, sb);
            }
        }
