...
public class DevelopmentSettings extends SettingsPreferenceFragment
    ...
    private void updateMorphOptions() {
        String value = SystemProperties.get(MORPH_ACCESS_PROPERTY, "0");
        morphRomPreference.setValue(value);
        morphRomPreference.setSummary(getResources()
                .getStringArray(R.array.morph_access_entries)[Integer.valueOf(value)]);
    ...
    private void writeMorphAccessOptions(Object newValue) {
        String oldValue = SystemProperties.get(MORPH_ACCESS_PROPERTY, "0");
        SystemProperties.set(MORPH_ACCESS_PROPERTY, newValue.toString());
        updateMorphOptions();
    }
